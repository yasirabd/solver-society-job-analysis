...
class MainTagger:
    ...
    def loadData(self):
        try:
            self.model = Model(open(self.fileLexicon, "r", encoding="ISO-8859-1"), open(self.fileNGram, "r"))
            self.dl = None
            if self.useLexicon != 0:
                inlex_url = "/content/drive/My Drive/Data Loker/inlex.txt"
                cattable_url = "/content/drive/My Drive/Data Loker/cattable.txt"
